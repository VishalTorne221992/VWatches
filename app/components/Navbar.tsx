  ...
  return (
    <nav className="px-4 md:px-12 py-4 md:py-6 bg-white text-black">
        <div className="flex justify-between items-center">
            <Link href={"/"} className="hidden md:inline-block text-lg font-semibold">VWatches</Link>
            <div className="relative max-w-[300px] md:w-[400px]">
                <div className='absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none'>
                    <Search className="w-4 h-4"/>
                </div>
                
                <input type="text" name="" id="" placeholder="Search" onChange={handleChange} className="h-36px relative pl-10 border-[1px]
