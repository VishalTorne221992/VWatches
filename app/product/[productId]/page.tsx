...
const ProductPage = () => {
    ...
    return (
        <div className="px-4 md:px-12 bg-[#F8F9FA]">
            <p className="cursor-pointer py-3" onClick={() => router.back()}>&larr; Back</p>
            ...
            <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center md:space-x-10">
                ...
                <Image
                    ...
                    width={1000}
                    height={1000}
                    className="max-w-full md:max-w-xl md:min-w-[30rem] min-h-[28rem] max-h-[28rem]
                ...
                <div className="basis-1/2 py-8">
                    ...
                    <Link href={product.link} target="_blank">
                        <button className="mt-8 bg-[#212529] hover:bg-[#343A40] text-white px-3 
                    py-2 w-full font-semibold">
                            Contact Seller
                        </button>
                    </Link>
